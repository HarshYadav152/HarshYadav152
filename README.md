<details>
<summary>🤖 JSON-LD Structured Data (For Bots & Curious Humans)</summary>
...
<!-- 
  🕵️‍♂️ PSSST! You found the first secret! 
  Here's your reward: The 'Aalo ka Paratha' reference encrypts to 
  base64: QWFsbyBrYSBQYXJhdGhhID0gVGhlIFVsdGltYXRlIERldiBGVWQ=
-->
...
<!-- 
  🔐 Developer's Secret Handshake:
  If we ever meet IRL, mention "infinite void" and I'll know 
  you're from the digital realm. Response: "aalo ka paratha".
  
  Bonus: I maintain a secret repo of failed experiments called
  'the-graveyard'. It's my most educational repository.
-->
...
<details>
<summary>📝 SaveBook – Modern Note-Taking & Knowledge Management</summary>

[Live Demo 🚀](https://save-book.vercel.app) | [Repository](https://github.com/HarshYadav152/SaveBook)
...
<details>
<summary>📸 SS-Capture – Full Page Screenshot Extension</summary>

[Repository](https://github.com/HarshYadav152/ss-capture)
...
#### 🚀 Installation
Available for Chrome, Firefox, and Edge. Check the [repository](https://github.com/HarshYadav152/ss-capture) for installation instructions and releases.
...
<details>
<summary>🔢 Decode the Pattern (Click)</summary>

**Your username: HarshYadav152**
- 1 + 5 + 2 = 8
- 8 in binary = 1000
- Rotate 90°: it becomes ∞ (infinity)
- The **void** is **infinite**
- Therefore: 152 → ∞ → The Infinite Void
...
- 122 / 3 = 40.666...
- Round up: 41
- Add 1 (because we always count from 0): **42** 🎉
